...
import com.application.jobConnect.entity.*;
import com.application.jobConnect.services.JobPostActivityService;
import com.application.jobConnect.services.JobSeekerApplyService;
import com.application.jobConnect.services.JobSeekerSaveService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model, @RequestParam(value="job", required = false)String job,
        ...
        if(!dateSearchFlag && !remote && !StringUtils.hasText(job) && !StringUtils.hasText(location)){
            ...
            jobPost = jobPostActivityService.search(job, location, Arrays.asList(partTime, fullTime, freelance), Arrays.asList(remoteOnly, officeOnly, partialRemote),
                    searchDate);
        }
